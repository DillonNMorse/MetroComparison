...
CH_circle_centers = CC.build_CH_circle_centers()

all_results = []
for circle_num, coord in enumerate(CH_circle_centers):

    lat = coord[0]
    lng = coord[1]
    radius = 1609.34 # 1 mile search radius for venues
    LIMIT = 200

# -*- coding: utf-8 -*-
"""
Created on Fri Jul 31 14:36:25 2020
...
tr_centers = CC.build_tr_circle_centers()

num_results = len(tr_centers)
all_results = []
for circle_num, coord in enumerate(tr_centers):
...
df.to_csv('triangle_venue_data.csv')     
